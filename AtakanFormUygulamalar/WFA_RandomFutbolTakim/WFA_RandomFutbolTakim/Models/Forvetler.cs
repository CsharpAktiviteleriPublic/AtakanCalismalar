...
{
    public class Forvetler : Futbolcu, ISut, IDuranTop
    {
        Random rnd = new Random();

        public int SutHizi { get; set; }
        public int SutFalso { get; set; }
        public int SutIsabeti { get; set; }
        ...
        public override string AdVer()
        {
            ...
            return Futbolcu.forvetAdi[randomSayilar[i++]];
        ...
        public Forvetler()
        {
            ...
            SutHizi = rnd.Next(70, 100);
            SutFalso = rnd.Next(70, 100);
            SutIsabeti = rnd.Next(70, 100);
